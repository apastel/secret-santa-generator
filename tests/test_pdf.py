...
def test_write_pairing_pdfs(tmp_path):
    ...
    for giver in mapping.keys():
        ...
        filename = outdir / f"To be opened by {safe_name} (Secret Santa {year}).pdf"
        ...
        # The visible repo name should be present and the URL should be embedded
        assert b"apastel/secret-santa-generator" in pdf_bytes
